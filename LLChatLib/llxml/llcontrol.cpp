...
LLControlGroup* LLControlGroup::mInstance = NULL;

LLControlGroup* LLControlGroup::getInstance()
{
	if( mInstance == NULL )
	{
		mInstance = new LLControlGroup;
	}
	return mInstance;
}


void LLControlGroup::Release()
{
	delete mInstance;
	mInstance = NULL;
}
...
// Why this is not in the linked output, I just don't know!
// TOTAL HACK!!!!
//
namespace boost
{
