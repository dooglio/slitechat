...
//char* _PREHASH_ChatterBoxInvitation = LLMessageStringTable::getInstance()->getString("ChatterBoxInvitation");
//char* _PREHASH_EstablishAgentCommunication = LLMessageStringTable::getInstance()->getString("EstablishAgentCommunication");
