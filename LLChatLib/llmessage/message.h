...
#define gMessageSystem (LLMessageSystem::getInstance())
...
public:
	...
	static void InitMessageSystem(const std::string& filename, U32 port, S32 version_major,
					S32 version_minor, S32 version_patch,
					bool failure_is_fatal,
					const F32 circuit_heartbeat_interval, const F32 circuit_timeout);

	static LLMessageSystem* getInstance();
	static void Release();
...
private:
	...
	static LLMessageSystem* mInstance;
