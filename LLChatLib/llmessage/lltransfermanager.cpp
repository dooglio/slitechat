...
LLTransferManager*	LLTransferManager::mInstance = NULL;
LLTransferSource::stype_scfunc_map LLTransferSource::sSourceCreateMap;


LLTransferManager* LLTransferManager::getInstance()
{
	if( mInstance == NULL )
	{
		mInstance = new LLTransferManager;
	}
	//
	return mInstance;
}
...
void LLTransferManager::Release()
{
	delete mInstance;
	mInstance = NULL;
}
