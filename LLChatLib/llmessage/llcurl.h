...
public:
	...
	typedef boost::shared_ptr<Easy> EasyPtr;
	typedef boost::shared_ptr<Multi> MultiPtr;
...
private:
	void addMulti();
	LLCurl::EasyPtr allocEasy();
	bool addEasy(LLCurl::EasyPtr easy);
	
private:
	typedef std::set<LLCurl::MultiPtr> curlmulti_set_t;
	curlmulti_set_t mMultiSet;
	LLCurl::MultiPtr mActiveMulti;
...
private:
	LLCurl::MultiPtr mMulti;
	LLCurl::EasyPtr mEasy;
	bool mRequestSent;
